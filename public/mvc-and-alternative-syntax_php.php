...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/zgulde/F298KRCUW/mvc-and-alternative-syntax_php.php?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U1SP89LSV");
							sb('set', 'user_' + "batch", "immediate-launch");
							sb('set', 'user_' + "created", "2016-07-18");
						sb('set', 'name_tag', "codeup" + '/' + "jessicasattler28");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>mvc-and-alternative-syntax.php | Codeup Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/c1ecc/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous">
    ...
    <link href="https://a.slack-edge.com/69bdd/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/83165802d4f7dcfe4cd99ea65d4b15a7.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0024-192.png')" data-thumb-size="48" data-member-id="U1SP89LSV"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/83165802d4f7dcfe4cd99ea65d4b15a7.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0024-72.png')" data-thumb-size="36" data-member-id="U1SP89LSV"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">jessicasattler28</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/2317866748?crumb=s-1473280105-0dc945a34c-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
	                            	...
	                            	<a href="https://codeup.slack.com/home" target="https://codeup.slack.com/">
	                        	                            ...
	                        	                            <li >
	                            	<a href="https://geekdomsa.slack.com/home" target="https://geekdomsa.slack.com/">
	                            			                            				                            		<i class="team_icon small" style="background-image: url('https://s3-us-west-2.amazonaws.com/slack-files2/avatars/2014-12-04/3148202344_2e0573a69e3088fe6bf2_88.jpg');"></i>
		                            		                            		<span class="switcher_label team_name">Geekdom SA</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	<strong>Created by zgulde on September 7, 2016 at 3:22 PM</strong><br />
	<span class="subtle_silver break_word">https://codeup.slack.com/files/zgulde/F298KRCUW/mvc-and-alternative-syntax_php.php</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T029BRGN0-F298KRCUW-05373a0644" target="new">https://slack-files.com/T029BRGN0-F298KRCUW-05373a0644</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		2KB PHP snippet created on <span class="date">September 7th 2016</span>.
...
&lt;/html&gt;
	...
	<noscript>
		...
		<form action="https://codeup.slack.com/files/zgulde/F298KRCUW/mvc-and-alternative-syntax_php.php"
		id="file_comment_form"
					class="comment_form"
				method="post">
			<a href="/team/jessicasattler28" class="member_preview_link" data-member-id="U1SP89LSV" >
			<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/83165802d4f7dcfe4cd99ea65d4b15a7.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0024-72.png')" data-thumb-size="36" data-member-id="U1SP89LSV"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1473280105-3db34b9e4d-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U1SP89LSV',
		no_login: false,
		version_ts: '1473279530',
		version_uid: 'c6dda0818131137ba4d2aa98d612a719754994b1',
		...
		clog_url: "clog\/track\/",
		api_token: 'xoxs-2317866748-60790326913-70257612707-7407639a94',
		ls_disabled: false,
		...
		feature_admin_long_list_view: true,
		...
		feature_app_review_scope_error: false,
		...
		feature_unread_view_onboarding: false,
		feature_tw: false,
		...
		feature_msg_input_placeholder: true,
		feature_jq_inspector: false,
		feature_multnomah: false,
		feature_sales_tax_address: false,
		feature_toggle_id_translation: false,
		feature_can_edit_app: true,
		feature_gdrive_1_dot_5: false,
		feature_user_provisioning_team_events: false,
		feature_ent_pricing_lp: false,
		feature_updated_consistency_check: false,
		feature_updated_history_fetch_and_merge: false,
...
//-->
				...
				<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/7855/js/rollup-core_required_libs.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/93d7/js/rollup-core_required_ts.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bc516/js/TS.web.js" crossorigin="anonymous"></script>

		<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/125e0/js/rollup-core_web.js" crossorigin="anonymous"></script>

		<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/d5dc/js/rollup-secondary_a_required.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/a0176/js/rollup-secondary_b_required.js" crossorigin="anonymous"></script>

					
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/8e19/js/TS.web.comments.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/72195/js/TS.web.file.js" crossorigin="anonymous"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/db4a/js/codemirror_load.js" crossorigin="anonymous"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F298KRCUW","created":1473279723,"timestamp":1473279723,"name":"mvc-and-alternative-syntax_php.php","title":"mvc-and-alternative-syntax.php","mimetype":"text\/plain","filetype":"php","pretty_type":"PHP","user":"U0PJ6BJHY","editable":true,"size":2092,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T029BRGN0-F298KRCUW\/mvc-and-alternative-syntax_php.php","url_private_download":"https:\/\/files.slack.com\/files-pri\/T029BRGN0-F298KRCUW\/download\/mvc-and-alternative-syntax_php.php","permalink":"https:\/\/codeup.slack.com\/files\/zgulde\/F298KRCUW\/mvc-and-alternative-syntax_php.php","permalink_public":"https:\/\/slack-files.com\/T029BRGN0-F298KRCUW-05373a0644","edit_link":"https:\/\/codeup.slack.com\/files\/zgulde\/F298KRCUW\/mvc-and-alternative-syntax_php.php\/edit","preview":"\u003C?php\r\n\r\n\/\/ model\r\n$pizzas = [\r\n    [\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-meta\"\u003E&lt;?php\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E\/\/ model\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-variable-2\"\u003E$pizzas\u003C\/span\u003E \u003Cspan class=\"cm-operator\"\u003E=\u003C\/span\u003E [\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    [\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":70,"lines_more":65,"channels":["C1SN2S4JK"],"groups":[],"ims":[],"comments_count":1,"initial_comment":{"id":"Fc298W9KED","created":1473279723,"timestamp":1473279723,"user":"U0PJ6BJHY","is_intro":true,"comment":"alternative syntax and model view controller ideas","channel":""}};
		boot_data.file.comments = [{"id":"Fc298W9KED","created":1473279723,"timestamp":1473279723,"user":"U0PJ6BJHY","is_intro":true,"comment":"alternative syntax and model view controller ideas","channel":""}];
		...
		$(function(){
			...
			CodeMirror.switchSlackMode(g_editor, "php");
		});
...
<!-- slack-www-hhvm280 / 2016-09-07 13:28:25 / vc6dda0818131137ba4d2aa98d612a719754994b1 / B:H -->
